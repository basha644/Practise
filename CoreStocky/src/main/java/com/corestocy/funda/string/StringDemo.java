...
public class StringDemo {
	...
	*/
    ...
    public static void main(String[] args) {
		...
		System.out.println(s.equals(s2)); //false Bcz,content is same but problem with first capital letter(Akbar)
		 ...
		 * NOTE: String is immutable in Java because of the security(used as passwords),
		 * caching (consumes multiple classes if changed it will be effected), and class loading(loaded in SCP).
		 * In heap area duplicates allowed.
           In SCP duplicates are not allowed
		 */

	/*	Summary of Comparisons
		Comparison Method	  String	                   StringBuffer	                    StringBuilder
		== (Reference)	      Compares references	       Compares references	            Compares references
	    .equals()	          Compares content	           Compares references (default)	Compares references (default)
        .compareTo()	      Lexicographical comparison	Not supported	                Not supported

		Practical Advice
		Use .equals()    for content comparison of String.
		Avoid .equals()  for StringBuffer or StringBuilder unless you override it.
		Use .compareTo() for sorting or comparing String lexicographically.
		Avoid ==         for content comparison as it only checks references.*/
	}
