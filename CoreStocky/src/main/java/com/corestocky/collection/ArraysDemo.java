...
public class ArraysDemo {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(names)); //"[akbar, basha, love]"
        ...
        int index = Arrays.binarySearch(names1, "basha"); // Returns index of "basha"
        System.out.println(index);

        int[] numbers = new int[5];
        Arrays.fill(numbers, 9); // All elements become 9
