...
public class SortedSetDemo {
	 ...
	 * If we want to represent a group of "unique objects" where duplicates are not allowed and all objects must be inserting
	 * according to some sorting order then we should go for SortedSet interface. 
