...
//	obj1.compareTo(obj2);
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Ar".compareTo("Ac"));//15
...
//		If we are not satisfying with default natural sorting order (or) if default natural sorting order is not available,
//		 then we can define our own customized sorting by Comparator object.
