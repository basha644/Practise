...
public class StreamApiDemo {
	/*
	 * In Java 8, Java supports Functional programming with the help of Lamda Expression(->)
	...
	/*
	 * can we do same operations without a stream using collection?
	...
	public static void main(String[] args) {
		...
		.map(m->m*2) // It implement the business logic for filtered one
		.forEach(System.out::println); // Method reference it Iterate and prints the streamed object.
		
//		l.forEach(f-> System.out.println(f));  // It prints list object
	}
}
